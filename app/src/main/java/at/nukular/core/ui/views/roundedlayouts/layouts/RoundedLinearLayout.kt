...
class RoundedLinearLayout @JvmOverloads constructor(
...
) : LinearLayout(context, attrs), RoundedLayout, UiComponent {
    ...
    init {
        ...
        if (attrs != null) {
            ...
            if (array.hasValue(R.styleable.RoundedLinearLayout_rl_radius_top_left)
                || array.hasValue(R.styleable.RoundedLinearLayout_rl_radius_top_right)
                || array.hasValue(R.styleable.RoundedLinearLayout_rl_radius_bottom_left)
                || array.hasValue(R.styleable.RoundedLinearLayout_rl_radius_bottom_right)
            ) {

                val topLeft = array.getDimensionPixelSize(
                    R.styleable.RoundedLinearLayout_rl_radius_top_left,
                    DEFAULT_RADIUS
                )
                val topRight = array.getDimensionPixelSize(
                    R.styleable.RoundedLinearLayout_rl_radius_top_right,
                    DEFAULT_RADIUS
                )

                val bottomLeft = array.getDimensionPixelSize(
                    R.styleable.RoundedLinearLayout_rl_radius_bottom_left,
                    DEFAULT_RADIUS
                )

                val bottomRight = array.getDimensionPixelSize(
                    R.styleable.RoundedLinearLayout_rl_radius_bottom_right,
                    DEFAULT_RADIUS
                )
